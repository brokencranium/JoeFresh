...
public class MapsActivity extends ActionBarActivity implements RetailStoresAdapter.OnItemClickListener {
...
//        mRetailStores = getResources().getStringArray(R.array.stores_array);
        String[] storeList = getResources().getStringArray(R.array.stores_array);
        if (mRetailStores == null) ;
        mRetailStores = new ArrayList<Model>();

        for (int i = 0; i < storeList.length; ++i) {
            mRetailStores.add(new Model(storeList[i]));
        }
...
// set up the drawer's list view with items and click listener
        mDrawerList.setAdapter(new RetailStoresAdapter(mRetailStores, this));
