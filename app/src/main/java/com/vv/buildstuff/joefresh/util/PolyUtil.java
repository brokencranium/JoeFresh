...
import static com.vv.buildstuff.joefresh.util.MathUtil.clamp;
import static com.vv.buildstuff.joefresh.util.MathUtil.hav;
import static com.vv.buildstuff.joefresh.util.MathUtil.havDistance;
import static com.vv.buildstuff.joefresh.util.MathUtil.havFromSin;
import static com.vv.buildstuff.joefresh.util.MathUtil.inverseMercator;
import static com.vv.buildstuff.joefresh.util.MathUtil.mercator;
import static com.vv.buildstuff.joefresh.util.MathUtil.sinFromHav;
import static com.vv.buildstuff.joefresh.util.MathUtil.sinSumFromHav;
import static com.vv.buildstuff.joefresh.util.MathUtil.wrap;
